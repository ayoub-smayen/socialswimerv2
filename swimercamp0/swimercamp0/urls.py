...
from .views import tnelmer,tnelmer2,tnelmer3,tnelmer4,tnelmer5,foodhome,bookevent,bookhomepage,cooments,forum1,blogfire,error_404,error_500,create_news,search_profile
from questions.views.questions import IndexView
...
urlpatterns = [
    path('profiles/<str:username>/', search_profile, name='profile1'),
    path('myquestions/', IndexView.as_view(), name='index'),
    path('markdownx/', include('markdownx.urls')),
    path('news1/', include('posts1.urls')),
  ...
  url('posts/', include('posts.urls', namespace="posts")),
    ...
    path("news/",create_news,name="news" ),



     path('forum1/', forum1, name='forum1'),
    re_path(r'^ayoubmyadmin/', admin.site.urls,name="admino"),
    ...
    path('yubiadmin/', admin.site.urls,name="adf"),
